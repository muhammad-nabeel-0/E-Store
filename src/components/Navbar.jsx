...
return (
    ...
    <NavLink to="/">
        <img src={assets.logo} className='w-3/5' alt="" />
    </NavLink>
      {/* navbar */}
    <ul className=' hidden  sm:flex gap-5 text-sm text-gray-700 font-medium '>
        ...
        <p className='a absolute right-[-5px] bottom-[-5px] w-5 text-center leading-4 rounded-full bg-black text-white text-[8px]'>11</p>
        </Link>
